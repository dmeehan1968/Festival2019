...
async function routes(context) {
  ...
  context.app.get('/events', require('server/routes/events').get)
  context.app.get('/events/:event', require('server/routes/events/id').get)
  context.app.get('/api/events', require('server/routes/api/events').get)
