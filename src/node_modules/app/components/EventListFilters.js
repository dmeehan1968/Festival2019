...
import { setRegionFilter, setDisciplinesFilter, setDatesFilter } from 'app/actions'
import SelectedOptions from 'app/components/SelectedOptions'
import useFetch from 'app/helpers/useFetch'
import DateTime from 'app/components/DateTime'
import moment from 'moment'

const EventListFilters = ({ className, filters, setRegionFilter, setDisciplinesFilter, setDatesFilter }) => {
  ...
  return (
    <form className={stringifyClassnames(styles.filters, className)} onSubmit={handleSubmit}>
      ...
      <SelectedOptions className={styles.options} title="Dates" options={data.dates} selected={dates} onChange={handleDateChange} labelKey="date" labelFormat={formatDate}/>
